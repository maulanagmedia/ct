package id.net.gmedia.gmedialiveconnection.MainTroubleAnalytic;
...
import id.net.gmedia.gmedialiveconnection.MainTroubleAnalytic.Fragment.MainPingTest;
import id.net.gmedia.gmedialiveconnection.MainTroubleAnalytic.Fragment.MainRouterStatus;
import id.net.gmedia.gmedialiveconnection.R;

public class MainTroubleAnalytic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_trouble_analytic);
    ...
    private void initUI() {
        ...
        tvTitle.setText("Trouble Analytic");
    }
